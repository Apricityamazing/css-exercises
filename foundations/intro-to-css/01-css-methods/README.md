...
### Self Check
Y Did you use all three methods of adding CSS to an HTML file?
Y Did you properly link the external CSS file in the HTML file?
Y Does the `div` element have CSS added via the external method?
Y Does the `p` element have CSS added via the internal method?
Y Does the `button` element have CSS added via the inline method?
